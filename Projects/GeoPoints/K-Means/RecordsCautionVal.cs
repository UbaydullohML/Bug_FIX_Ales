...
class Program 
{
    static void Main(string[] args) // main method is entry point for program
    {
        ...
        // add k-means centroids to the allData list
        allData.AddRange(downsampledData);
        ...
        using var writer1 = new StreamWriter("RecordsCautionVal.csv");  // create new StreamWriter called writer1 to write downsampled data.
